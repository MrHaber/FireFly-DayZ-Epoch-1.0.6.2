/*
	DZAI_unitDeath
	Описание: Вызывается когда кровь равна нуль.
	Используйте: [_unit,_killer] call DZAI_unitDeath;
*/
...
// Проверяем число ботов в группе, preserve group immediately if empty.
