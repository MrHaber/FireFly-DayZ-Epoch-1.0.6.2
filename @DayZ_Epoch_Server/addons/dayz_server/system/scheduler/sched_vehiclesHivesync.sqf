sched_vehicleshivewrite =
{
	...
	// Каждую минуту
	// Принудительно обновим Технику с Базой Данных (Урон или Позицию или ТаймАут)
	_n = 0;
	{
	...
	if (_n > 0) then
	{
		diag_log format ["[СЕРВЕР]: [sched_vehiclesHivesync]: [ПЛАНИРОВЩИК]:%1: синхронизированно %2 техники с Базой Данных", __FILE__, _n];
	};
