...
if (_playerUID in dayz_ghostPlayers) exitWith
{
	...
	diag_log format["[СЕРВЕР]: [server_onPlayerDisconnect.sqf]: ОШИБКА: Невозможно синхронизировать игрока [%1,%2] Возможно он все еще Логиниться",_playerName,_playerUID]; 
