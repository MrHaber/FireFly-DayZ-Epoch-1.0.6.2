...
diag_log format ["[СЕРВЕР]: [server_spawnCrashSites]: ХЕЛИКРАШ: Запускаем ХелиКраш. Частота: %1±%2 мин. Шанс Спавна: %3", SPAWN_FREQUENCY, SPAWN_VARIANCE, SPAWN_CHANCE];
...
_spawnCrashSite =
{
	...
	diag_log format ["[СЕРВЕР]: [server_spawnCrashSites]: ХЕЛИКРАШ: Спавним ХелиКраш (%1) на %2 с %3 предметами.", _class, _position, _lootNum];
