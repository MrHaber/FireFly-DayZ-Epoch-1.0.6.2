...
_playerName		=	toString (_this select 4);	// Отправлено как Массив чтобы избежать ограничений publicVariable
...
if (_characterID != "0") then
{
	...
	/*
		...
		diag_log ("[БАЗА ДАННЫХ]: [server_playerDied]: ЗАПИСЬ: "+ str(_key));
	*/
