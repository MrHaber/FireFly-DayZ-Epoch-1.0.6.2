...
_primary	=	["Crossbow_DZ","Remington870_DZ","Winchester1866_DZ","MR43_DZ","LeeEnfield","Bizon_DZ","L85A2_DZ","SA58_RIS_DZ","M16A4_DZ","M16A2_DZ","MP5_DZ","Mosin_DZ","M1014_DZ","M14_DZ","M4A1_DZ","G36C_DZ","AK74_DZ","AKS74U_DZ","AKM_DZ","AKS_74","SCAR_L_CQC"] call loadout_fnc_selectRandom;
_secondary	=	["G17_DZ","M1911_DZ","M9_DZ","Makarov_DZ","Revolver_DZ","PDW_DZ"] call loadout_fnc_selectRandom;
...
DefaultMagazines		=	["ItemBandage","ItemMorphine","ItemPainkiller",_ammo,_ammos,_ammos]; 
DefaultWeapons			=	[_primary,_secondary]; 
DefaultBackpack			=	_backpack; 
DefaultBackpackItems	=	[_food,_drink,_light];