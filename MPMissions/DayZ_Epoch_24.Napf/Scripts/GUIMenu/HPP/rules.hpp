...
{
	idc = 1105;
	text = "Правила сервера"; //--- ToDo: Localize;
	x = 0.427719 * safezoneW + safezoneX;
	y = 0.1304 * safezoneH + safezoneY;
	w = 0.12 * safezoneW;
	h = 0.055 * safezoneH;
	sizeEx = 0.050;
...
{
	idc = 1600;
	text = "Следующая страница"; //--- ToDo: Localize;
...
{
	idc = 1602;
	text = "Предыдущая страница"; //--- ToDo: Localize;
	x = 0.45 * safezoneW + safezoneX;
	y = 0.8102 * safezoneH + safezoneY;
	w = 0.0979687 * safezoneW;
	h = 0.044 * safezoneH;
...
class slk_return: slkRscButton
{
	...
	style = 2;
	colorBackground[] = {0.047,0.376,0.776,1};
	onButtonClick = "((ctrlParent (_this select 0)) closeDisplay 7778); ExecVM 'Scripts\GUIMenu\menu_init.sqf';";
};
